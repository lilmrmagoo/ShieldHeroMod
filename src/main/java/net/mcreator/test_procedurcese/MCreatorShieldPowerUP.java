...
public class MCreatorShieldPowerUP extends Elementstest_procedurcese.ModElement {
	private KeyBinding keys;

	public MCreatorShieldPowerUP(Elementstest_procedurcese instance) {
		super(instance, 15);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.shieldpowerup", Keyboard.KEY_C, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			MCreatorShieldPowerUPOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
