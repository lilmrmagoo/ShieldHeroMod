...
public class MCreatorActivateShieldPower extends Elementstest_procedurcese.ModElement {
	private KeyBinding keys;

	public MCreatorActivateShieldPower(Elementstest_procedurcese instance) {
		super(instance, 12);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.activateshieldpower", Keyboard.KEY_H, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			MCreatorRopeShieldItemRightClicked.executeProcedure($_dependencies);
		}
	}
}
