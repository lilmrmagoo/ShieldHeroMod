...
public class MCreatorShieldMenuOpen extends Elementstest_procedurcese.ModElement {
	private KeyBinding keys;

	public MCreatorShieldMenuOpen(Elementstest_procedurcese instance) {
		super(instance, 31);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.shieldmenuopen", Keyboard.KEY_M, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			MCreatorShieldMenuOpenPressed.executeProcedure($_dependencies);
		}
	}
}
