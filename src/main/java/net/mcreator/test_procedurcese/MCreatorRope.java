...
public class MCreatorRope extends Elementstest_procedurcese.ModElement {
	@GameRegistry.ObjectHolder("test_procedurcese:rope")
	public static final Block block = null;

	public MCreatorRope(Elementstest_procedurcese instance) {
		super(instance, 8);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("test_procedurcese:rope", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			...
			world.scheduleUpdate(new BlockPos(x, y, z), this, this.tickRate(world));
			{
				...
				MCreatorRopeBlockAdded.executeProcedure($_dependencies);
			}
		}
